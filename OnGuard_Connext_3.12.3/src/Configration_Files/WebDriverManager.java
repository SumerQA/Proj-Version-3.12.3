...
public class WebDriverManager {
	...
	public static WebDriver startDriver(String browser, String URL)
		...
		if (browser.equals("FF")) {
			...
			System.setProperty("webdriver.gecko.driver", "D://Selenium projects//Workspace//OnGuard_Connext_3.12.3//drivers//geckodriver.exe");
		...
		if (browser.equals("CH")) {
			...
			System.setProperty("webdriver.chrome.driver","D://Selenium projects//Workspace//OnGuard_Connext_3.12.3//drivers//chromedriver.exe");
		...
		if (browser.equals("IE")) {
			try {
				...
				System.setProperty("webdriver.ie.driver","D://Selenium projects//Workspace//OnGuard_Connext_3.14//drivers//IEDriverServer.exe");
